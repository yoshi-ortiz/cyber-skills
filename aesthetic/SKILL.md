...
Load [loop.md](references/loop.md) after the URL is in chat. Read the last DECISIONS row and the last PNG of the incumbent before drawing. `--asks` is that one move. Do not open this skill's scripts.
