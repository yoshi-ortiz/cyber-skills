...
| `first` | `genesis`; `plan`; `first-plan-roadmap`; `first-take-note`; `first-idea-sketch`; `first-work-style`; `first-aesthetic`; `aesthetic` | `alpha` | [`genesis/SKILL.md`](genesis/SKILL.md), [`aesthetic/SKILL.md`](aesthetic/SKILL.md) | Interview before you architect, Promote to a spec, Fetch what you do not know, Source before you write, Update the state | `PARTIAL` | `R-32`, `R-35`, `E-02`, `E-03`, `E-04` |
| `first` graphics | `text-to-graphics` (loop reference, no separate command yet) | `alpha` | [`aesthetic/SKILL.md`](aesthetic/SKILL.md) | Source before you write | `PARTIAL` | `R-59` |
