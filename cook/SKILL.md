...
Eat your own food. Run the skill the way a user runs it, then check the page,
not the exit code.
...
A dogfood round writes corpus, ledger, renders, and companion sessions. Writing
...
| `screen-is-rankable` | that screen carries a scoring control |
